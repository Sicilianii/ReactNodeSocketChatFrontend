...
export default function AddNewChat__features() {
    ...
    const [close, toClose] = useState(false);
    ...
    return(
        <>
            <button className={'add-chat-btn'} onClick={ ()=> toClose(!close) }>
            ...
            <ModalWindow close={close} toClose={toClose} >
                <form className={'modal-form'} onSubmit={ (e) => {
                    ...
                    <ul className={'profile-friends-wrapper'} style={{
                        ...
                        {
                            myProfileFriends.entities.map( (el, id) =>  <ChangeListFriendsForChat friend={el} friendID={id} addUser={setUsersInChat}/>)
                        }

                    </ul>
                    <WhitePurpleButtonShared className={'profile-friends__link'} type={'submit'}
